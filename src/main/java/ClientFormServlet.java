...
public class ClientFormServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("  }");
		out.println("  </style>");
		out.println("  <title>New Client</title>");
		out.println("</head>");
		out.println("<body>");
		out.println("  <div class=\"centeredColumn\">");		
		out.println("    <img src=\"https://cdn.discordapp.com/attachments/404053019827896333/463500783959146499/move.png\" height=\"20%\" width=\"20%\" alt=\"logo\">");
		...
		out.println("    </div>");
		out.println("  </div>");
		out.println("  	<h1 id=\"title\" class=\"display-4\" style=\"text-align: center;\">Novo Cliente</h1>");
		out.println("  <div class=\"content centeredColumn\">");
		out.println("<form action = \"insert-client\" method = \"POST\">");		
