...
public class ClientListServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("      <a href=\"/APP/new-client\">New Client</a>");
		out.println("   <table>");
		out.println("   <tr>");
		...
		for (Client client : clients) {
            ...
            out.println("<td>" + client.getAdress() + "</td>");
            out.println("<td>" + client.getDate_of_birth() + "</td>");
            out.println("<td>" + client.getCpf() + "</td>");
            out.println("<td>" + client.getEmail() + "</td>");
            out.println("<td>" + client.getPhone() + "</td>");
            out.println("<td>" + client.getPasswd() + "</td>");
    		out.println("</tr>");
